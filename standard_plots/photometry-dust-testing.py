...
def plot_lfs(plt, outdir, obsdir, h0, LFs_dust, LFs_nodust):
    ...
    common.savefig(outdir, fig, "SDSS_luminosity_functions-tau-EAGLE.pdf")
    ...
    common.savefig(outdir, fig, "VISTA_luminosity_functions-tau-EAGLE.pdf")
    ...
    common.savefig(outdir, fig, "IRAC_luminosity_functions-tau-EAGLE.pdf")
    ...
    common.savefig(outdir, fig, "IR_luminosity_functions-tau-EAGLE.pdf")
...
def plot_colours(plt, outdir, obsdir, h0, colours_dist):
    ...
    common.savefig(outdir, fig, 'ur_colour_z0-tau-EAGLE.pdf')
    ...
    common.savefig(outdir, fig, 'gr_colour_z0-tau-EAGLE.pdf')
...
def plot_uv_lf_evo(plt, outdir, obsdir, h0, LFs_dust, LFs_nodust):
    ...
    common.savefig(outdir, fig, "UV_luminosity_function_evolution-tau-EAGLE.pdf")
...
def main(model_dir, outdir, redshift_table, subvols, obsdir):
    ...
    for index, snapshot in enumerate(snapshots):
        ...
        seds, ids, nbands, tau_screen = common.read_photometry_data_variable_tau_screen(model_dir, snapshot, subvols)
