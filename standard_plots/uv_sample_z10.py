...
def prepare_data(hdf5_data, phot_data, phot_data_nod, LFs_dust, LFs_nodust, index, nbands):
    ...
    (h0, volh, mdisk, mbulge, mhalo, mshalo, typeg, age,
     sfr_disk, sfr_burst, id_gal, xg, yg, zg, vxg, vyg, vzg) = hdf5_data
    ...
    for a,b,c,d,e,f,g,h in zip(mduv, mduv_nod, xg, yg, zg, vxg, vyg, vzg):
...
def main(model_dir, outdir, redshift_table, subvols, obsdir):
    ...
    fields = {'galaxies': ('mstars_disk', 'mstars_bulge', 'mvir_hosthalo',
                           ...
                           'sfr_disk', 'sfr_burst', 'id_galaxy',  'position_x',
    ...
    z = [10] #(3.0, 4.0, 6.0, 8.0, 10.0)  #(8.0, 9, 10.5, 12.5) #, 1.0, 1.5, 2.0)
