...
GalaxyWriter::GalaxyWriter(ExecutionParameters exec_params, CosmologicalParameters cosmo_params,  const CosmologyPtr &cosmology, std::shared_ptr<DarkMatterHalos> darkmatterhalo, SimulationParameters sim_params):
